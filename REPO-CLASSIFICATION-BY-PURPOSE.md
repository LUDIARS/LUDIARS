...
| Tr | [Tirocinium](https://github.com/LUDIARS/Tirocinium) | 面接練習 AI (Sonnet 応答 + GPT 深掘り + Opus 評価の三重奏で「人間に近い面接官」) |
...
| Di | [Discutere](https://github.com/LUDIARS/Discutere) | Chat-to-Task 自動化 |
...
| Su | [Susurrus](https://github.com/LUDIARS/Susurrus) | ローカル先行チャット (md 正本 + SQLite キャッシュ、 会話ログ蓄積) |
| — | Ludus (※未スキャフォールド) | 遊びの辞書 (ゲームメカニクスや遊び体験の語彙化) |

> **メモ**: Ludus は LUDIARS org に独立 repo として未存在 (2026-05-28 時点)。
> 関連実装は Ars 配下の `ars-game-lexicon` + `game-template` (LUDIARS/Ars
> プラグイン pack) に分散。 別 repo 化する場合はここに登録予定。
...
| Eg | [Ergo](https://github.com/LUDIARS/Ergo) | C++ モジュラーフレームワーク (Pictor 上層) |
...
| It | [Iter](https://github.com/LUDIARS/Iter) | C++ コンパイルエラー可視化 |
...
| カテゴリ | 件数 | 主な傾向 |
|----------|------|----------|
| 1. 新時代 | 5 | 一番尖った layer。 ここを増やしたい |
| 2. ワークフロー | 20 | 一番太い layer。 「悪い病気」 自認の通り過剰 |
| 3. データ | 5+α | Memoria を軸に複数 vertical の個人データ蓄積 |
| 4. ゲーム開発 | 3 | LUDIARS 外 2 / 内 1。 Pictor / Ergo の dogfood |
| 5. ライブラリ | 14 | 上の 4 種を支える下層 |
